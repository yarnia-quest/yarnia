...
Built **June 6** (the product). Thin layer: story generation (OpenAI/Qwen) + ElevenLabs TTS + InstantDB writes; returns audio URLs to `app/`. Plus the content-safety guardrail (age/fear constraints) before any story reaches a child.
